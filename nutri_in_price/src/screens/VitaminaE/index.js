...
export const VitaminaE = () => {
    ...
    useEffect(  () => {
        fetch('http://200.131.52.34:3000/alimentos/8/33').then((res) => res.json().then(data => setAlimentos(data)))
    },[alimentos]);
                    ...
                    <ScrollView>
                        <PageBody>  
                            <ScrollView>
                                ...
                                <AreaTitle>
                                    <TextHeather>Ranking de Vitamina E</TextHeather>

...
export const Sodio = () => {
    ...
    useEffect(  () => {
        fetch('http://200.131.52.34:3000/alimentos/10/33').then((res) => res.json().then(data => setAlimentos(data)))
    },[alimentos]);
                    ...
                    <ScrollView>
                        <PageBody>  
                            <ScrollView>
                                ...
                                <AreaTitle>
                                    <TextHeather>Ranking de Sódio</TextHeather>
